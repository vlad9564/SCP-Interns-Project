...
public class DoctorDto   {
   ...
   * @return id
  **/
  @ApiModelProperty(value = "The objectId of the Doctor")
   ...
   * @return firstName
  **/
  @ApiModelProperty(value = "The first name of the Doctor")
   ...
   * @return lastName
  **/
  @ApiModelProperty(value = "The last name of the Doctor")
   ...
   * @return department
  **/
  @ApiModelProperty(value = "The department of the Doctor")
   ...
   * @return age
  **/
  @ApiModelProperty(value = "The age of the Doctor")
  ...
  public boolean equals(java.lang.Object o) {
    ...
    return Objects.equals(this.id, doctorDto.id) &&
        ...
        Objects.equals(this.department, doctorDto.department) &&
        Objects.equals(this.age, doctorDto.age);
  }
